	...
	con.connect(function(err) {
		...
		for (let i = 0; i < 1000; i++) {
			...
			bcrypt.hash("123456789", 10, function(err, hash) {
				...
				con.query(f,[c[3],c[2],hash,c[0],c[1], c[6], getRandomInt(3), c[4],c[5], getRandomInt(2), 0, getRandomInt(400), faker.date.between('1960-01-01', '2001-12-31')],function (err, result, fields) {
					console.log(err);
					if (result && !err) {
