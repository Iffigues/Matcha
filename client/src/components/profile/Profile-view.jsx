			...
			<div className="container">
				...
				<div className="row">
					<div className="col-sm-4">
						<img className="card-img pt-3 pb-3" src={profilePhoto ? 'http//localhost:8080/' + profilePhoto.path : avatar} alt="..."/>
					</div>
				</div>
				...
				<div className="row">
					{props.photos.map((photo, key) => 
						<div key={key} className="col-sm-3">
							<div className="card">
								<img className="card-img-top" src={'http//localhost:8080/' + photo.path} alt="..."/>
							</div>
						</div>)}
				</div>
				<div>
